...
> Firebase is a Backend as a service **Baas** by *Google*, Firebase provides a real-time backend for various kinds of applications it provides: 
- [x] data store
- [x] authentication
- [x] static hosting
